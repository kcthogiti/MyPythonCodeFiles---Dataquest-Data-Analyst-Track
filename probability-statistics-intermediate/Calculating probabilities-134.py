...
m = bikes[bikes["cnt"] > 4000].shape[0]

probability_over_4000 = m/total_days
...
prob_8 = find_outcome_combinations(10, 8)*calprob(10, 8)
prob_9 = find_outcome_combinations(10, 9)*calprob(10, 9)
prob_10 = find_outcome_combinations(10, 10)*calprob(10,10)
